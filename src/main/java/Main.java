...
public class Main {
    ...
    private static void createBook() {
        ...
        Book book = new Book(title, author, price, stock, releaseDate);
        bookDao.save(book);  // Save book using the DAO
    ...
    private static void updateBook() {
        ...
        if (existingBook != null) {
            ...
            bookDao.update(existingBook);  // Update the book using the DAO
    ...
    private static void deleteBook() {
        ...
        if (book != null) {
            bookDao.delete(book);  // Delete the book using the DAO
    ...
    private static void listAllBooks() {
        List<Book> books = bookDao.getBooks();  // Fetch all books using the DAO
        if (books.isEmpty()) {
